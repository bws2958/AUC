...
import cloud.artik.example.hellocloud.Util.Config;
import cloud.artik.model.Message;
import cloud.artik.model.MessageIDEnvelope;
import cloud.artik.model.NormalizedMessagesEnvelope;
import cloud.artik.model.UserEnvelope;

import static cloud.artik.example.hellocloud.Util.Config.DEVICE_ID;
...
public class AdminActivity extends Activity {
    ...
    private void processFailure(final String context, ApiException exc) {
        ...
        exc.printStackTrace();
        showErrorOnUIThread(context+errorDetail, AdminActivity.this);
    }
